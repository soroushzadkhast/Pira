...
public class Utilities {
    ...
    public static String getCurrentShamsidate(Date date) {
        ...
        String year = convertToPersianDigits(String.valueOf(sc.year));
        String month = convertToPersianDigits(String.format(loc, "%02d", sc.month));
        String day = convertToPersianDigits(String.format(loc, "%02d", sc.date));
    ...
    public static String getCurrentdate(Date date) {
        ...
        String month = String.format(loc, "%02d", sc.month);
        String day = String.format(loc, "%02d", sc.date);
