...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int tabFirstColor = 0x77FFFFFF;
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (v instanceof TextView) {
                ...
                if (i == 0) {
                    ...
                    tab2.setTextColor(tabFirstColor);
                } else if (i == 2) {
                    tab3 = (TextView) v;
                    tab3.setTextSize(TypedValue.COMPLEX_UNIT_PX, tabTextSize);
                    tab3.setTypeface(tabTypeface, tabTypefaceStyle);
                    tab3.setTextColor(tabFirstColor);
                }
                ...
                if (textAllCaps) {
                    if (i == 0) {
                        ...
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
                            ...
                            tab2.setText(tab1.getText().toString().toUpperCase(locale));
                        }
                    } else if (i == 0) {
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
                            tab3.setAllCaps(true);
                        } else {
                            tab3.setText(tab1.getText().toString().toUpperCase(locale));
                        }
                    }
                }
            }
    ...
    private class PageListener implements OnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            ...
            if (position == 0){
                ...
                if (position == 1){
                    tab1.setTextColor(tabFirstColor);
                    tab3.setTextColor(tabFirstColor);
